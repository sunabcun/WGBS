...
tss.exprs <- read.table("./all.matrix_Genes_expressed.0.tab", skip=3, sep="\t", header=F, stringsAsFactors=F)
tss.noexprs <- read.table("./all.matrix_Genes_noexpressed.0.tab", skip=3, sep="\t", header=F, stringsAsFactors=F)
